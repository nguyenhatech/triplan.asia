            ...
            <div class="box-title">
                <div class="box-search">
                    <div class="input-group search-box">
                        ...
                        <input type="text" value="" id="input-search" class="form-control typeahead" :placeholder="(trans ? trans.web_home_baner_top_placehoder_input : 'Tìm dịch vụ ở ') + place_name" aria-describedby="button-addon2" style="border-right: 0px;" v-model="filters.q">
                        <div class="input-group-append">
                            <button v-if="filters.q" @click="filters.q = ''" class="btn" type="button" id="button-addon2">
