...
<html lang="{{ \App::getLocale() }}">
    ...
    <body>
        <div class="top-section parallax" style="background-image: url('http://flamingodailai.com/wp-content/uploads/Resize-FDL-7.jpg');">
            ...
            <div class="modal-dialog" role="document" style="height: 100%;">
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <iframe id="videoIframe" width="100%" height="auto" src="https://www.youtube.com/embed/mcBXv0OyXNQ?rel=0&amp;controls=0&amp;showinfo=0&amp;start=16&amp;enablejsapi=1&amp;vq=hd720" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row height-full">
                    <div class="col-12 col-md-5 height-full">
                        <div class="d-flex flex-column justify-content-center" style="height: 100%;">
                            <h2 class="section-title">Chốn nghỉ dưỡng tuyệt vời</h2>
        ...
        <div class="service-section single-section parallax" style="background-image: url('http://flamingodailai.com/wp-content/uploads/banner.png');">
            <div class="container">
                <div class="row">
        ...
        <div class="service-section single-section parallax" style="background-image: url('http://flamingodailai.com/wp-content/uploads/Resize-FDL-12.jpg');">
            <div class="container">
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="container">
        ...
        <section class="service-section">
            <div class="container">
                <h2 class="text-center section-title">Nhiều hoạt thư giãn, giải trí đa dạng</h2>
                <div class="row">
        ...
        <section class="footer" style="background-image: url('http://flamingodailai.com/wp-content/uploads/DJI_0025-3-1.jpg');">
            <div class="row">
                <div class="col-12 col-md-4">
